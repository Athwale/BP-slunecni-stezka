...
public class SunPathInfoFragment extends Fragment {
    ...
    private void fillText(View view) {
        ...
        textViewTop.setText(mHtmlConverter.getHtmlForTextView(getString(R.string.sun_path_info_top)));
        textViewTop.setMovementMethod(LinkMovementMethod.getInstance());

        TextView textViewMiddle = (TextView) (view.findViewById(R.id.info_screen_text_view_middle));
        textViewMiddle.setText(mHtmlConverter.getHtmlForTextView(getString(R.string.sun_path_info_middle)));
        textViewMiddle.setMovementMethod(LinkMovementMethod.getInstance());

        TextView textViewBottom = (TextView) (view.findViewById(R.id.info_screen_text_view_bottom));
        textViewBottom.setText(mHtmlConverter.getHtmlForTextView(getString(R.string.sun_path_info_bottom)));
