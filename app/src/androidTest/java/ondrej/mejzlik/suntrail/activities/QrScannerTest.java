...
public class QrScannerTest {
    ...
    @Test
    public void qrScannerTest() {
        ViewInteraction button = onView(
                allOf(withId(R.id.main_menu_button_scan), withText("Scan"),
                        withParent(allOf(withId(R.id.linearLayout3),
                                withParent(withId(R.id.main_menu_activity_relative_layout)))),
                        isDisplayed()));
        ...
        ViewInteraction view = onView(
                allOf(childAtPosition(
                        childAtPosition(
                                withId(R.id.scanner_fragment_container),
                                0),
                        0),
                        isDisplayed()));
